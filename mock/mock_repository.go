...
func (m *MockITodoRepository) CreateTodo(todoList *[]model.Todo, todoObj model.Todo) model.Todo {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTodo", todoList, todoObj)
	ret0, _ := ret[0].(model.Todo)
	return ret0
}

// CreateTodo indicates an expected call of CreateTodo.
func (mr *MockITodoRepositoryMockRecorder) CreateTodo(todoList, todoObj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTodo", reflect.TypeOf((*MockITodoRepository)(nil).CreateTodo), todoList, todoObj)
}
