...
func (m *MockITodoService) CreateTodo() model.Todo {
	m.ctrl.T.Helper()
...
func (mr *MockITodoServiceMockRecorder) CreateTodo() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTodo", reflect.TypeOf((*MockITodoService)(nil).CreateTodo))
}
